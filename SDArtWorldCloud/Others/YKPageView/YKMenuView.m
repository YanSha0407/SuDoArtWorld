...
- (void)refreshContenOffset {
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"currentIndex" object:[NSNumber numberWithInteger:index]];
